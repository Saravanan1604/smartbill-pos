...
const ROLE_ACCESS = {
  admin:    new Set(['dashboard','billing','products','inventory','reports','customers','settings','subscription']),
  owner:    new Set(['dashboard','billing','products','inventory','reports','customers','subscription']),
